...
(function (e) {
    ...
    var t = function (t, n) {
        ...
        this.sort = function () {
            ...
            var e = this, t = /^(Jan|January|Feb|February|Mar|March|Apr|April|May|Jun|June|Jul|July|Aug|August|Sep|September|Oct|October|Nov|November|Dec|December|(0?\d{1})|(10|11|12))(-|\s|\/|\.)(0?[1-9]|(1|2)[0-9]|3(0|1))(-|\s|\/|\.|,\s)(19|20)?\d\d$/i;
            e.sortBy && typeof e.data[0][e.sortBy] != "undefined" && e.data.sort(n(e.sortBy, e.reverse))
        };
        this.filter = function () {
            var t = this, n = t.searchableFields.length;
            if (t.query) {
                var r = new RegExp(t.query, "gi");
                t.data = e.grep(t.data, function (e) {
                    for (var i = 0; i < n; i++)if (typeof e[t.searchableFields[i]] == "string") {
        ...
        this.condition = function () {
            var e = this, t = [];
            if (e.schema) {
                var n = e.data.length, r = e.schema.length;
                for (var i = 0; i < n; i++) {
                    var s = e.data[i], o = {};
                    for (var u = 0; u < r; u++) {
                        var a = e.schema[u];
        ...
        this.create = function () {
            ...
            function r(n, r) {
                var i = [];
                n % 2 === 0 ? i.push('<tr class="' + t.evenRowClass + '">') : i.push('<tr class="' + t.oddRowClass + '">');
                e.each(t.schema, function (e, n) {
                    n.hide || (n.template ? i.push("<td>" + t.chevron(n.template, r) + "</td>") : i.push("<td>" + r[n.key] + "</td>"))
                });
                i.push("</tr>");
                return i
            }
        ...
        this.init = function () {
            ...
            function s() {
                e.ajax({
                    url: t.templateFile, async: !1, success: function (e) {
                        t.template = e
                    }, error: function () {
    ...
    t.prototype = {
        ...
        setRange: function () {
            var e = (this.page - 1) * this.size, t = e + this.size < this.total ? e + this.size : this.total;
            this.range = {start: e + 1, end: t}
        },
        setTotal: function (e) {
            this.total = e;
            return !0
...
(function (e, t) {
    ...
    function m(t, r) {
        function m() {
            if (f && !l)while (u.length)delete o[u.pop()]; else u = [];
            f = !1;
            l = !1
        }
        ...
        if (!t)return [];
        var s = [], o = [], u = [], f = !1, l = !1, w, E, S;
        x(r || e.tags);
        var T = new b(t), N, C, k, L, A, O;
        while (!T.eos()) {
            N = T.pos;
            k = T.scanUntil(w);
            if (k)for (var M = 0, _ = k.length; M < _; ++M) {
                L = k.charAt(M);
    ...
    E.prototype.render = function (e, t, n) {
        var r = this.parse(e), i = t instanceof w ? t : new w(t);
        ...
        for (var h = 0, p = t.length; h < p; ++h) {
            ...
            switch (l[0]) {
                case"#":
                    c = i.lookup(l[1]);
                    if (!c)continue;
                    if (n(c))for (var d = 0, v = c.length; d < v; ++d)u += this.renderTokens(l[4], i.push(c[d]), s, o); else if (typeof c == "object" || typeof c == "string")u += this.renderTokens(l[4], i.push(c), s, o); else if (r(c)) {
